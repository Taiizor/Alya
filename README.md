...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci (n=30)** | `11.1 ms` | **`14.1 ms`** | `29.0 ms` | `140.9 ms` | **2.1x faster** | **10.0x faster** |
| **Mandelbrot Fractal (200×100)** | `11.3 ms` | **`15.2 ms`** | `32.1 ms` | `120.6 ms` | **2.1x faster** | **7.9x faster** |
| **Sieve of Eratosthenes (50k)** | `9.8 ms` | **`13.1 ms`** | `31.6 ms` | `41.2 ms` | **2.4x faster** | **3.1x faster** |
| **FNV-1a String Hash (50k)** | `17.1 ms` | **`15.2 ms`** | `33.1 ms` | `433.9 ms` | **2.2x faster** | **28.5x faster** |
