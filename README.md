...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci (n=30)** | `2.5 ms` | **`9.2 ms`** | `13.2 ms` | `123.2 ms` | **1.4x faster** | **13.4x faster** |
| **Mandelbrot Fractal (200×100)** | `3.2 ms` | **`8.3 ms`** | `10.3 ms` | `127.3 ms` | **1.2x faster** | **15.3x faster** |
| **Sieve of Eratosthenes (50k)** | `1.0 ms` | **`1.6 ms`** | `7.4 ms` | `18.2 ms` | **4.6x faster** | **11.3x faster** |
| **FNV-1a String Hash (50k)** | `4.9 ms` | **`9.2 ms`** | `14.0 ms` | `425.4 ms` | **1.5x faster** | **46.4x faster** |
