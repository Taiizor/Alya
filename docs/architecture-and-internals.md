...
```bash
# View lexer tokens
alyac tokens examples/hello.alya

# View parsed Abstract Syntax Tree
alyac ast examples/hello.alya
```
...
alyac examples/fibonacci.alya -S -o fib.s

# Target Apple Silicon ARM64 assembly
alyac examples/fibonacci.alya --arch arm64 -S -o fib_arm64.s
```
...
alyac run examples/mini_compiler.alya --time
```
