...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.3 ms` | **`9.0 ms`** | `12.2 ms` | `120.2 ms` | **3.8x** | **13.4x faster** | **1.4x faster** |
| **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.2 ms` | **`8.1 ms`** | `8.8 ms` | `128.2 ms` | **2.5x** | **15.9x faster** | **1.1x faster** |
| **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.6 ms`** | `6.7 ms` | `17.2 ms` | **1.6x** | **11.1x faster** | **4.3x faster** |
| **FNV-1a String Hash** | 50,000 hash calculations | `4.7 ms` | **`8.6 ms`** | `12.4 ms` | `425.2 ms` | **1.8x** | **49.2x faster** | **1.4x faster** |
...
* **Result:** **3.8x of C (-O2)**, **1.4x faster than Bun**, and **13.4x faster than Python**.
...
* **Result:** **2.5x of C (-O2)**, **1.1x faster than Bun**, and **15.9x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **1.4x faster than Bun**, and **49.2x faster than Python**.
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **`Lexer::tokenize`** | 1343 | `297.94 µs` | `959.00 ns` | `10.68 µs` | `289.87 µs` | `482.84 µs` | **`508.73 KB`** | `1.00` | **72.9 MB/s** |
| **`Parser::parse`** | 581 | `688.74 µs` | `7.13 µs` | `52.21 µs` | `614.43 µs` | `994.40 µs` | **`981.01 KB`** | `1.93` | **1708922 lines/s** |
| **`ProgramInference::analyze`** | 48 | `8.38 ms` | `21.32 µs` | `42.70 µs` | `8.33 ms` | `8.50 ms` | **`74.86 KB`** | `0.15` | **119 ops/s** |
| **`CodeGen::generate (x64)`** | 10 | `40.18 ms` | `478.67 µs` | `330.00 µs` | `39.85 ms` | `40.73 ms` | **`2.79 MB`** | `5.61` | **253374 asm lines/s** |
| **`Full Frontend Pipeline`** | 13 | `40.03 ms` | `421.87 µs` | `367.41 µs` | `39.41 ms` | `40.62 ms` | **`3.91 MB`** | `7.88` | **25.0 files/s** |
