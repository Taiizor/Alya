...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.3 ms` | **`8.9 ms`** | `12.8 ms` | `121.1 ms` | **3.8x** | **13.6x faster** | **1.4x faster** |
| **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.2 ms` | **`8.1 ms`** | `9.7 ms` | `124.2 ms` | **2.6x** | **15.3x faster** | **1.2x faster** |
| **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.6 ms`** | `6.9 ms` | `17.1 ms` | **1.7x** | **10.6x faster** | **4.3x faster** |
| **FNV-1a String Hash** | 50,000 hash calculations | `4.7 ms` | **`8.9 ms`** | `12.7 ms` | `427.1 ms` | **1.9x** | **48.2x faster** | **1.4x faster** |
...
* **Result:** **1.7x of C (-O2)**, **4.3x faster than Bun**, and **10.6x faster than Python**.
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **`Lexer::tokenize`** | 1372 | `291.52 µs` | `725.00 ns` | `8.17 µs` | `283.12 µs` | `385.98 µs` | **`508.73 KB`** | `1.00` | **74.5 MB/s** |
| **`Parser::parse`** | 545 | `734.69 µs` | `3.11 µs` | `22.09 µs` | `666.75 µs` | `835.74 µs` | **`1.03 MB`** | `2.08` | **1602041 lines/s** |
| **`ProgramInference::analyze`** | 53 | `7.56 ms` | `28.06 µs` | `59.03 µs` | `7.50 ms` | `7.88 ms` | **`74.86 KB`** | `0.15` | **132 ops/s** |
| **`CodeGen::generate (x64)`** | 11 | `36.94 ms` | `210.61 µs` | `168.72 µs` | `36.70 ms` | `37.27 ms` | **`2.78 MB`** | `5.60` | **271638 asm lines/s** |
| **`Full Frontend Pipeline`** | 13 | `38.62 ms` | `303.93 µs` | `264.70 µs` | `38.13 ms` | `39.03 ms` | **`3.98 MB`** | `8.01` | **25.9 files/s** |
