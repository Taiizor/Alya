...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `1.8 ms` | **`7.7 ms`** | `10.7 ms` | `98.5 ms` | **4.2x** | **12.8x faster** | **1.4x faster** |
| **Mandelbrot Fractal** | 200×100 grid, 200 iters | `2.7 ms` | **`6.8 ms`** | `7.8 ms` | `106.1 ms` | **2.5x** | **15.6x faster** | **1.1x faster** |
| **Sieve of Eratosthenes** | Primes under 50,000 | `0.8 ms` | **`1.3 ms`** | `5.2 ms` | `15.2 ms` | **1.6x** | **11.8x faster** | **4.0x faster** |
| **FNV-1a String Hash** | 50,000 hash calculations | `4.1 ms` | **`6.0 ms`** | `10.8 ms` | `371.0 ms` | **1.5x** | **61.5x faster** | **1.8x faster** |
...
* **Result:** **4.2x of C (-O2)**, **1.4x faster than Bun**, and **12.8x faster than Python**.
...
* **Result:** **2.5x of C (-O2)**, **1.1x faster than Bun**, and **15.6x faster than Python**.
...
* **Result:** **1.6x of C (-O2)**, **4.0x faster than Bun**, and **11.8x faster than Python**.
...
* **Result:** **1.5x of C (-O2)**, **1.8x faster than Bun**, and **61.5x faster than Python**.
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **`Lexer::tokenize`** | 1743 | `229.45 µs` | `403.00 ns` | `5.12 µs` | `223.58 µs` | `313.56 µs` | **`508.73 KB`** | `1.00` | **94.7 MB/s** |
| **`Parser::parse`** | 849 | `471.18 µs` | `1.58 µs` | `13.96 µs` | `420.13 µs` | `586.59 µs` | **`1009.57 KB`** | `1.98` | **2498008 lines/s** |
| **`ProgramInference::analyze`** | 69 | `5.83 ms` | `9.79 µs` | `24.71 µs` | `5.79 ms` | `5.95 ms` | **`70.36 KB`** | `0.14` | **172 ops/s** |
| **`CodeGen::generate (x64)`** | 16 | `25.16 ms` | `169.25 µs` | `174.34 µs` | `25.05 ms` | `25.78 ms` | **`656.14 KB`** | `1.29` | **353647 asm lines/s** |
| **`Full Frontend Pipeline`** | 20 | `25.78 ms` | `56.17 µs` | `64.70 µs` | `25.68 ms` | `25.90 ms` | **`1.79 MB`** | `3.61` | **38.8 files/s** |
