...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.5 ms` | **`9.2 ms`** | `13.2 ms` | `123.2 ms` | **3.7x** | **13.4x faster** | **1.4x faster** |
| **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.2 ms` | **`8.3 ms`** | `10.3 ms` | `127.3 ms` | **2.6x** | **15.3x faster** | **1.2x faster** |
| **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.6 ms`** | `7.4 ms` | `18.2 ms` | **1.6x** | **11.3x faster** | **4.6x faster** |
| **FNV-1a String Hash** | 50,000 hash calculations | `4.9 ms` | **`9.2 ms`** | `14.0 ms` | `425.4 ms` | **1.9x** | **46.4x faster** | **1.5x faster** |
...
* **Result:** **3.7x of C (-O2)**, **1.4x faster than Bun**, and **13.4x faster than Python**.
...
* **Result:** **1.6x of C (-O2)**, **4.6x faster than Bun**, and **11.3x faster than Python**.
...
* **Result:** **1.9x of C (-O2)**, **1.5x faster than Bun**, and **46.4x faster than Python**.
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **`Lexer::tokenize`** | 1321 | `302.86 µs` | `835.00 ns` | `9.23 µs` | `293.09 µs` | `399.35 µs` | **`508.73 KB`** | `1.00` | **71.7 MB/s** |
| **`Parser::parse`** | 544 | `735.71 µs` | `2.56 µs` | `18.11 µs` | `668.62 µs` | `815.37 µs` | **`1.03 MB`** | `2.08` | **1599817 lines/s** |
| **`ProgramInference::analyze`** | 50 | `8.10 ms` | `23.95 µs` | `48.95 µs` | `8.02 ms` | `8.24 ms` | **`74.86 KB`** | `0.15` | **124 ops/s** |
| **`CodeGen::generate (x64)`** | 11 | `38.37 ms` | `224.04 µs` | `179.48 µs` | `38.18 ms` | `38.73 ms` | **`2.78 MB`** | `5.60` | **261485 asm lines/s** |
| **`Full Frontend Pipeline`** | 13 | `38.67 ms` | `417.82 µs` | `363.88 µs` | `38.22 ms` | `39.60 ms` | **`3.98 MB`** | `8.01` | **25.9 files/s** |
