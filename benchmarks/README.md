...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.4 ms` | **`8.6 ms`** | `12.5 ms` | `121.1 ms` | **3.6x** | **14.1x faster** | **1.5x faster** |
| **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.2 ms` | **`8.1 ms`** | `10.1 ms` | `125.1 ms` | **2.6x** | **15.4x faster** | **1.2x faster** |
| **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.6 ms`** | `6.6 ms` | `18.5 ms` | **1.6x** | **11.7x faster** | **4.2x faster** |
| **FNV-1a String Hash** | 50,000 hash calculations | `4.8 ms` | **`8.7 ms`** | `13.4 ms` | `423.5 ms` | **1.8x** | **48.8x faster** | **1.5x faster** |
...
* **Result:** **2.6x of C (-O2)**, **1.2x faster than Bun**, and **15.4x faster than Python**.
...
* **Result:** **1.6x of C (-O2)**, **4.2x faster than Bun**, and **11.7x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **1.5x faster than Bun**, and **48.8x faster than Python**.
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **`Lexer::tokenize`** | 1323 | `302.29 µs` | `688.00 ns` | `7.61 µs` | `293.30 µs` | `389.33 µs` | **`508.73 KB`** | `1.00` | **71.9 MB/s** |
| **`Parser::parse`** | 589 | `679.76 µs` | `2.88 µs` | `21.24 µs` | `615.97 µs` | `848.50 µs` | **`981.01 KB`** | `1.93` | **1731489 lines/s** |
| **`ProgramInference::analyze`** | 34 | `11.83 ms` | `392.74 µs` | `661.86 µs` | `11.58 ms` | `15.39 ms` | **`170.71 KB`** | `0.34` | **85 ops/s** |
| **`CodeGen::generate (x64)`** | 10 | `41.97 ms` | `225.93 µs` | `155.75 µs` | `41.76 ms` | `42.32 ms` | **`2.93 MB`** | `5.89` | **245167 asm lines/s** |
| **`Full Frontend Pipeline`** | 12 | `44.06 ms` | `812.77 µs` | `680.08 µs` | `42.57 ms` | `44.78 ms` | **`4.05 MB`** | `8.16` | **22.7 files/s** |
