...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.3 ms` | **`8.6 ms`** | `12.6 ms` | `120.0 ms` | **3.7x** | **14.0x faster** | **1.5x faster** |
| **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.1 ms` | **`8.1 ms`** | `9.4 ms` | `120.5 ms` | **2.6x** | **14.9x faster** | **1.2x faster** |
| **Sieve of Eratosthenes** | Primes under 50,000 | `0.9 ms` | **`1.6 ms`** | `6.4 ms` | `16.7 ms` | **1.7x** | **10.6x faster** | **4.1x faster** |
| **FNV-1a String Hash** | 50,000 hash calculations | `4.7 ms` | **`8.6 ms`** | `12.5 ms` | `430.5 ms` | **1.8x** | **50.2x faster** | **1.5x faster** |
...
* **Result:** **3.7x of C (-O2)**, **1.5x faster than Bun**, and **14.0x faster than Python**.
...
* **Result:** **2.6x of C (-O2)**, **1.2x faster than Bun**, and **14.9x faster than Python**.
...
* **Result:** **1.7x of C (-O2)**, **4.1x faster than Bun**, and **10.6x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **1.5x faster than Bun**, and **50.2x faster than Python**.
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **`Lexer::tokenize`** | 1364 | `293.28 µs` | `693.00 ns` | `7.78 µs` | `283.68 µs` | `379.38 µs` | **`508.73 KB`** | `1.00` | **74.1 MB/s** |
| **`Parser::parse`** | 571 | `701.04 µs` | `4.24 µs` | `30.78 µs` | `636.88 µs` | `790.13 µs` | **`981.01 KB`** | `1.93` | **1678928 lines/s** |
| **`ProgramInference::analyze`** | 51 | `7.99 ms` | `32.50 µs` | `67.08 µs` | `7.92 ms` | `8.29 ms` | **`74.86 KB`** | `0.15` | **125 ops/s** |
| **`CodeGen::generate (x64)`** | 11 | `37.95 ms` | `1.30 ms` | `1.04 ms` | `36.05 ms` | `38.94 ms` | **`2.79 MB`** | `5.61` | **271176 asm lines/s** |
| **`Full Frontend Pipeline`** | 13 | `38.59 ms` | `476.39 µs` | `414.89 µs` | `38.09 ms` | `39.26 ms` | **`3.91 MB`** | `7.88` | **25.9 files/s** |
