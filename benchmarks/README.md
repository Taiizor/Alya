...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.3 ms` | **`8.9 ms`** | `12.9 ms` | `120.8 ms` | **3.8x** | **13.6x faster** | **1.5x faster** |
| **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.2 ms` | **`8.1 ms`** | `9.3 ms` | `125.8 ms` | **2.6x** | **15.5x faster** | **1.1x faster** |
| **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.6 ms`** | `6.5 ms` | `16.7 ms` | **1.6x** | **10.6x faster** | **4.1x faster** |
| **FNV-1a String Hash** | 50,000 hash calculations | `4.7 ms` | **`8.6 ms`** | `12.7 ms` | `427.1 ms` | **1.8x** | **49.5x faster** | **1.5x faster** |
...
* **Result:** **3.8x of C (-O2)**, **1.5x faster than Bun**, and **13.6x faster than Python**.
...
* **Result:** **1.6x of C (-O2)**, **4.1x faster than Bun**, and **10.6x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **1.5x faster than Bun**, and **49.5x faster than Python**.
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **`Lexer::tokenize`** | 1349 | `296.56 µs` | `570.00 ns` | `6.37 µs` | `287.04 µs` | `375.82 µs` | **`508.73 KB`** | `1.00` | **73.2 MB/s** |
| **`Parser::parse`** | 590 | `678.11 µs` | `2.60 µs` | `19.17 µs` | `620.42 µs` | `771.35 µs` | **`981.01 KB`** | `1.93` | **1735706 lines/s** |
| **`ProgramInference::analyze`** | 52 | `7.79 ms` | `18.07 µs` | `37.65 µs` | `7.75 ms` | `7.95 ms` | **`74.86 KB`** | `0.15` | **128 ops/s** |
| **`CodeGen::generate (x64)`** | 11 | `38.55 ms` | `185.03 µs` | `148.23 µs` | `38.37 ms` | `38.94 ms` | **`2.79 MB`** | `5.61` | **264088 asm lines/s** |
| **`Full Frontend Pipeline`** | 13 | `39.57 ms` | `330.30 µs` | `287.66 µs` | `39.22 ms` | `40.03 ms` | **`3.91 MB`** | `7.88` | **25.3 files/s** |
