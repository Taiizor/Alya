...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.5 ms` | **`9.1 ms`** | `13.3 ms` | `121.6 ms` | **3.7x** | **13.3x faster** | **1.5x faster** |
| **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.2 ms` | **`8.3 ms`** | `9.4 ms` | `121.8 ms` | **2.6x** | **14.7x faster** | **1.1x faster** |
| **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.6 ms`** | `7.0 ms` | `18.6 ms` | **1.6x** | **11.5x faster** | **4.4x faster** |
| **FNV-1a String Hash** | 50,000 hash calculations | `5.0 ms` | **`9.0 ms`** | `13.5 ms` | `437.3 ms` | **1.8x** | **48.5x faster** | **1.5x faster** |
...
* **Result:** **3.7x of C (-O2)**, **1.5x faster than Bun**, and **13.3x faster than Python**.
...
* **Result:** **2.6x of C (-O2)**, **1.1x faster than Bun**, and **14.7x faster than Python**.
...
* **Result:** **1.6x of C (-O2)**, **4.4x faster than Bun**, and **11.5x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **1.5x faster than Bun**, and **48.5x faster than Python**.
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **`Lexer::tokenize`** | 1362 | `293.70 µs` | `673.00 ns` | `7.55 µs` | `285.45 µs` | `379.42 µs` | **`508.73 KB`** | `1.00` | **74.0 MB/s** |
| **`Parser::parse`** | 591 | `677.18 µs` | `4.41 µs` | `32.59 µs` | `613.40 µs` | `872.69 µs` | **`981.01 KB`** | `1.93` | **1738083 lines/s** |
| **`ProgramInference::analyze`** | 53 | `7.66 ms` | `26.35 µs` | `55.44 µs` | `7.60 ms` | `7.88 ms` | **`74.86 KB`** | `0.15` | **131 ops/s** |
| **`CodeGen::generate (x64)`** | 11 | `37.92 ms` | `216.65 µs` | `173.56 µs` | `37.70 ms` | `38.24 ms` | **`2.79 MB`** | `5.61` | **271362 asm lines/s** |
| **`Full Frontend Pipeline`** | 13 | `38.95 ms` | `354.44 µs` | `308.69 µs` | `38.48 ms` | `39.40 ms` | **`3.91 MB`** | `7.88` | **25.7 files/s** |
