...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.3 ms` | **`8.6 ms`** | `12.6 ms` | `122.1 ms` | **3.7x** | **14.2x faster** | **1.5x faster** |
| **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.2 ms` | **`8.1 ms`** | `9.9 ms` | `122.0 ms` | **2.5x** | **15.0x faster** | **1.2x faster** |
| **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.5 ms`** | `6.2 ms` | `17.0 ms` | **1.6x** | **11.0x faster** | **4.0x faster** |
| **FNV-1a String Hash** | 50,000 hash calculations | `4.7 ms` | **`8.6 ms`** | `12.5 ms` | `432.9 ms` | **1.8x** | **50.2x faster** | **1.4x faster** |
...
* **Result:** **3.7x of C (-O2)**, **1.5x faster than Bun**, and **14.2x faster than Python**.
...
* **Result:** **1.6x of C (-O2)**, **4.0x faster than Bun**, and **11.0x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **1.4x faster than Bun**, and **50.2x faster than Python**.
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **`Lexer::tokenize`** | 1349 | `296.44 µs` | `688.00 ns` | `7.68 µs` | `288.31 µs` | `377.06 µs` | **`508.73 KB`** | `1.00` | **73.3 MB/s** |
| **`Parser::parse`** | 551 | `725.81 µs` | `12.50 µs` | `89.16 µs` | `620.11 µs` | `934.93 µs` | **`981.01 KB`** | `1.93` | **1621626 lines/s** |
| **`ProgramInference::analyze`** | 34 | `11.93 ms` | `44.00 µs` | `74.15 µs` | `11.79 ms` | `12.16 ms` | **`170.71 KB`** | `0.34` | **84 ops/s** |
| **`CodeGen::generate (x64)`** | 10 | `43.13 ms` | `243.12 µs` | `167.60 µs` | `42.88 ms` | `43.49 ms` | **`2.92 MB`** | `5.89` | **239449 asm lines/s** |
| **`Full Frontend Pipeline`** | 12 | `43.55 ms` | `427.89 µs` | `358.04 µs` | `43.04 ms` | `44.42 ms` | **`4.05 MB`** | `8.15` | **23.0 files/s** |
