...
impl CodeGen {
    pub(super) fn generate_if(&mut self, condition: &Expr, then_block: &[Stmt], else_block: Option<&[Stmt]>) {
    ...
    pub(super) fn generate_try_catch(&mut self, try_block: &[Stmt], catch_var: Option<&str>, catch_block: &[Stmt]) {
